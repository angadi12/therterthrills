...
import { Createbranchapi, Getbranch,Getbranchanalytics,Getbranchsummary,Getbranchdetails } from "@/lib/API/Branch";
...
const branchSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchBranchdetails.pending, (state, action) => {
      ...
      .addCase(fetchBranchdetails.rejected, (state, action) => {
        state.branchDetailsloading = false;
        state.branchDetailserror = action.payload;
      });
  },
});
