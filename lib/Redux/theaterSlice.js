...
const theaterSlice = createSlice({
  ...
  reducers: {
    ...
    setupcomingtheatreid(state, action) {
      state.upcomingtheatreid = action.payload;
    },
    setActivetheatreid(state, action) {
      state.Activetheatreid = action.payload;
    },
    setHourlytheaterid(state, action) {
      state.Hourlytheaterid = action.payload;
    },
  },
