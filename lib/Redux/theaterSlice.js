...
import { Gettheaterlocations, Gettheaterlocationsandslots,GetAlltheater,GetTheateravailablitybyid ,Gettheaterbyid} from '@/lib/API/Theater';
...
export const { setDate, setSelectedLocation ,setSelectedTheater,setSelectedSlotid} = theaterSlice.actions;
