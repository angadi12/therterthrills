...
export const Getunbookingbyid = async (id) => {

  try {
    let result = await fetch(`${BaseUrl}/Unsaved/getUnsavedBookingById/${id}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
      },
...
export const Getbookingbyslottheaterid = async (data) => {
  try {
    const url = `${BaseUrl}/Booking/getSlotAvailability`;
...
export const Changeslot = async (data) => {
  try {
    const url = `${BaseUrl}/Booking/changeSlot`;
...
export const GetRefundbookingbytheaterid = async (id, selectedTab, startDate, endDate) => {
  try {
    const params = new URLSearchParams();
    if (selectedTab) params.append("status", selectedTab);
    if (startDate) params.append("startDate", startDate);
    ...
    const url = `${BaseUrl}/Booking/GetRefundallbookingbytheater/${id}?${params.toString()}`;
    const response = await fetch(url, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const GetRefundbookingbyBranchid = async (id, selectedTab, startDate, endDate) => {
  try {
    const params = new URLSearchParams();
    if (selectedTab) params.append("status", selectedTab);
    if (startDate) params.append("startDate", startDate);
    ...
    const url = `${BaseUrl}/Booking/getRefundAllBookingByBranchId/${id}?${params.toString()}`;
    const response = await fetch(url, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const Getunsavedbookingbytheaterid = async (id, selectedTab, startDate, endDate) => {
  ...
  try {
    ...
    let result = await fetch(`${BaseUrl}/Unsaved/getAllUnsavedBookings/${id}?${params.toString()}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
      },
...
export const GetunsavedbookingbyBranchid = async (id, selectedTab, startDate, endDate) => {
  ...
  try {
    ...
    let result = await fetch(`${BaseUrl}/Unsaved/getAllUnsavedBookingsbybranchid/${id}?${params.toString()}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
      },
