...
import { MessageCircle, ChevronDown, MessageSquare, Phone,ChevronsDown} from "lucide-react";
  ...
  return (
    <div className="fixed md:bottom-6 bottom-20 right-6 z-50">
          ...
          >
            <div className="bg-white rounded-2xl shadow-lg md:w-[300px] w-full p-6 relative">
              ...
              <div className="space-y-2 mb-6">
                <h2 className="text-xl font-semibold bg-clip-text inline-block text-transparent bg-gradient-to-r from-[#F30278] via-[#F30278] to-[#E2B600]">Hi there!</h2>
              ...
              onClick={() => window.open('https://wa.me/9398617123', '_blank')}
              >
      ...
      <motion.button
        ...
        className="bg-[#F30278] hover:bg-opacity-90 w-14 h-14 rounded-full shadow-lg flex items-center justify-center text-white transition-colors"
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
      >
{!isOpen? <Phone className="w-6 h-6" />: <ChevronsDown  className="w-6 h-6" />}      </motion.button>
    </div>
  )
}
