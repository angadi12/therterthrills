...
const blogPosts = [
  {
    ...
    description:
      "This a filler for this blog, real content will be added during development process Read More",
  },
  {
    image: Blog2,
    title: "This is a Demo Title",
  ...
  return (
    <div className="w-11/12 mx-auto  py-12">
      ...
      <div className="text-center">
        <Button
          onClick={() => router.push("/Viewallblogs")}
          size="sm"
          className="px-8 py-0.5 w-60 rounded-none  border-none bg-[#004AAD] border-black dark:border-white uppercase text-white  transition duration-200 text-sm shadow-[1px_1px_#F30278,1px_1px_#F30278,1px_1px_#F30278,2px_2px_#F30278,2px_2px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)] "
        >
          View All
        </Button>
      </div>
