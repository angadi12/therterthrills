...
const BenefitsList = ({ benefits }) => (
  <div className="bg-pink-100 ring-1 ring-[#F30278] p-4 rounded-lg">
    ...
    <ul className="list-disc list-inside text-[#F30278] ">
...
const ServiceSection = ({
  ...
  <div className={`grid grid-cols-1 justify-center items-stretch md:grid-cols-2 py-8 md:px-12 px-3 w-full md:gap-12 gap-6 md:mb-12 ${reverse ? 'md:[&>*:first-child]:order-last bg-[#F7F7F7]' : ''}`}>
    ...
    <div className="flex flex-col justify-center">
      ...
      <p className="mb-4  leading-7 text-[#595959]">{description}</p>
