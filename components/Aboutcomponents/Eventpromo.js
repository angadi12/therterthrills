    ...
    <div className="w-11/12 mx-auto py-12">
      ...
      <div className="flex space-x-4">
        ...
        <div className="flex justify-center items-center h-16 w-16 rounded-full bg-[#F30278]">
           <Image src={Groupicon} alt="Groupicon" className="object-contain h-10 w-10"/>
        ...
        <div className="flex-1 bg-[#004AAD]/20 ring-1 ring-[#004AAD] rounded-lg p-3 text-white flex gap-2 items-center">
           ...
           <Image src={Star} alt="Star" className="object-contain h-10 w-10"/>
        ...
        <div className="w-full  space-y-6">
          <h1 className="text-3xl font-medium">
            ...
            <span className="bg-clip-text font-semibold inline-block text-transparent bg-gradient-to-r from-[#004AAD] via-[#F30278] to-[#E2B600]">Memorable Experience!</span>{" "}
          </h1>
