    ...
    <div className="max-w-lg mx-auto md:py-16 py-8">
      ...
      <Card className="w-full rounded-sm ">
        <CardContent className="p-6 flex flex-col justify-center items-center gap-4">
          ...
          <Button onClick={()=>router.push("https://maps.app.goo.gl/BjkHuGPN21XGnkYG6")} className="px-8 py-0.5 w-48 rounded-none  border-none bg-[#004AAD] border-black dark:border-white uppercase text-white  transition duration-200 text-sm shadow-[1px_1px_#F30278,1px_1px_#F30278,1px_1px_#F30278,2px_2px_#F30278,2px_2px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)] ">
